...
class login_window:
    def __init__(self, root):
        ...
        self.bg = ImageTk.PhotoImage(file = "images/bg3.png")
        lbl_bg = Label(self.root, image=self.bg)
        lbl_bg.place(x=0, y=0, relwidth=1, relheight=1)

        original_frame_image = Image.open("images/loginbg1.jpg")
        resized_frame_image = original_frame_image.resize((400, 550), Image.BICUBIC)
        self.bg1 = ImageTk.PhotoImage(resized_frame_image)

        original_frame_image1 = Image.open("images/NBA.png")
...
class Register:
    def __init__(self, root):
        ...
        #########bg image#####
        self.bg1 = ImageTk.PhotoImage(file="images/LBJ.png")
    ...
    ################## MAIN_FRAME############
        ...
        img1=Image.open("images/login-png-royalty-free_60202203531a5.png")
...
class AdminWindow:
    def __init__(self, root):
        ...
        original_frame_image = Image.open("images/leftframe.jpg")
...
class Insert_win:
    def __init__(self, root):
        ...
        original_frame_image = Image.open("images/leftframe2.jpg")
        ...
        original_frame_ima = Image.open("images/matchesdis.jpg")
        ...
        original_frame_ima = Image.open("images/ranking.jpg")
...
class update_win:
    def __init__(self, root):
        ...
        original_frame_image = Image.open("images/update_player.jpg")
        ...
        original_frame_ima = Image.open("images/update_match.jpg")
        resized_frame_ima = original_frame_ima.resize((300, 425), Image.BICUBIC)
        self.bg2 = ImageTk.PhotoImage(resized_frame_ima)
...
class display_win:
    def __init__(self, root):
        ...
        original_frame_image = Image.open("images/dis_team.jpg")
        resized_frame_image = original_frame_image.resize((300, 400), Image.BICUBIC)
        self.bg1 = ImageTk.PhotoImage(resized_frame_image)
        ...
        original_frame_ima = Image.open("images/leftframe2.jpg")
...
class player_info_window:
    def __init__(self, root):
        ...
        original_bg1 = Image.open("images/UPDATE PLAYER.jpg")
...
class match_info_win:
    def __init__(self, root):
        ...
        original_bg1 = Image.open("images/insert match.png")
        resized_bg1 = original_bg1.resize((470, 550), Image.BICUBIC)
        self.bg1 = ImageTk.PhotoImage(resized_bg1)
        left_lbl = Label(self.frame_border, image=self.bg1)
        left_lbl.place(x=10, y=10, width=470, height=550)
...
class team_stand:
    def __init__(self, root):
        ...
        original_bg1 = Image.open("images/ranking.jpg")
        resized_bg1 = original_bg1.resize((470, 550), Image.BICUBIC)
        self.bg1 = ImageTk.PhotoImage(resized_bg1)
        left_lbl = Label(self.frame_border, image=self.bg1)
        left_lbl.place(x=10, y=10, width=470, height=550)
...
class del_player_info_window:
    def __init__(self, root):
        ...
        original_bg1 = Image.open("images/LBJ.png")
        resized_bg1 = original_bg1.resize((470, 550), Image.BICUBIC)
        self.bg1 = ImageTk.PhotoImage(resized_bg1)
        left_lbl = Label(self.frame_border, image=self.bg1)
        left_lbl.place(x=10, y=10, width=470, height=550)
...
class display_TEAMS_win:
    def __init__(self, root):
        ...
        self.bg = ImageTk.PhotoImage(file="images/nbaLeague.jpg")
        lbl_bg = Label(self.root, image=self.bg)
        lbl_bg.place(x=0, y=0, relwidth=1, relheight=1)

        ######### Resize and display the frame image #####
        original_frame_image = Image.open("images/frame display.png")
        ...
        # Warriors BUTTON
        gsw_btn = Button(left_lbl, text="Warriors",command=self.gsw_s, font=("times new roman", 20, "bold"), borderwidth=4, fg="dark blue",
                         bg="yellow", activeforeground="black", activebackground="red")
        gsw_btn.place(x=43, y=30, width=205, height=35)

        # Lakers BUTTON
        rea_btn = Button(left_lbl, text="Lakers",command=self.lakers_s, font=("times new roman", 20, "bold"), borderwidth=4, fg="BLUE",
                         bg="yellow", activeforeground="black", activebackground="red")
        rea_btn.place(x=340, y=30, width=205, height=35)

        # MAVS BUTTON
        mavs_btn = Button(left_lbl, text="MAVS",command=self.mavs_s, font=("times new roman", 20, "bold"), borderwidth=4, fg="red",
                         bg="yellow", activeforeground="black", activebackground="red")
        mavs_btn.place(x=640, y=30, width=205, height=35)
    ...
    def lakers_s(self):
        self.ply_windown=Toplevel(self.root)
        self.app=display_lakers_win(self.ply_windown)

    def gsw_s(self):
        self.ply_windown=Toplevel(self.root)
        self.app=display_GSW_win(self.ply_windown)

    def mavs_s(self):
        self.ply_windown=Toplevel(self.root)
        self.app=display_mavs_win(self.ply_windown)  

class display_lakers_win:
    def __init__(self, root):
        self.root = root
        self.root.title("Lakers")
        self.root.geometry("1550x800+0+0")
        ...
        original_bg = Image.open("images/bg2321.png")
...
class display_GSW_win:
    def __init__(self, root):
        self.root = root
        self.root.title("gsw windows")
        self.root.geometry("1550x800+0+0")
        ...
        original_bg = Image.open("images/new bg.png")
        resized_bg = original_bg.resize((1400, 750), Image.BICUBIC)  # Set the desired width and height
        self.bg = ImageTk.PhotoImage(resized_bg)
...
class display_mavs_win:
    def __init__(self, root):
        ...
        original_bg = Image.open("images/bgweq21.png")
        resized_bg = original_bg.resize((1400, 750), Image.BICUBIC)  # Set the desired width and height
        self.bg = ImageTk.PhotoImage(resized_bg)
...
class display_MATCHESSSS_win:
    def __init__(self, root):
        ...
        # Load background image
        self.bg = ImageTk.PhotoImage(file="images/MATCHES SCH.png")
        lbl_bg = Label(self.root, image=self.bg)
        lbl_bg.place(x=0, y=0, relwidth=1, relheight=1)
...
class display_RANK_win:
    def __init__(self, root):
        ...
        # Load background image
        self.bg = ImageTk.PhotoImage(file="images/STANDING.png")
        lbl_bg = Label(self.root, image=self.bg)
        lbl_bg.place(x=0, y=0, relwidth=1, relheight=1)
...
class display_playerinfo_win:
    def __init__(self, root):
        ...
        # Load background image
        self.bg = ImageTk.PhotoImage(file="images/PLAYER INFO.png")
        lbl_bg = Label(self.root, image=self.bg)
